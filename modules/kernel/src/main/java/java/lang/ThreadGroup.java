...
public class ThreadGroup {
    ...
    static ThreadGroup root;  // added for bootstrap.c support
	...
	public boolean allowThreadSuspension(boolean b) {
		// fixit -- from the comments immediately above, not really sure what is supposed to be implemented
        // in any case, returning "true" is good enough for "hello world" demo
		return true;
	}
