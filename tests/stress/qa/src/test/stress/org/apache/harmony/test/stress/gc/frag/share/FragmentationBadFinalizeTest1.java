...
/**
 */
public class FragmentationBadFinalizeTest1 extends FragmentationAbstractTest {
    ...
    class FinalizedObject {
        FragmentationBadFinalizeTest1 test = null;

        byte[] bytes = null;

        FinalizedObject(FragmentationBadFinalizeTest1 test, int size) {
            this.test = test;
            bytes = new byte[size];
        }
