...
public class FragmentationRandomTest extends FragmentationAbstractTest {

    protected final int STEP_SIZE = 50;
    ...
    public void perform() {
        ...
        try {
            for (; i < NUM; ++i) {
                ...
                int size = rand.nextInt(BLOB_SIZE) + MIN_BLOB_SIZE;
                ...
                if (count > PERIOD) {
                    ...
                    // whcih varies from 2 to , so, the heap becomes fragmented
                    int step = rand.nextInt(STEP_SIZE) + 2;
