...
class ResultDialog {
	 ...
	 */
	ResultDialog(Shell parent, String mbean, String op, String[] params, Object result) {
		result_SHELL = new Shell(parent, SWT.APPLICATION_MODAL | SWT.CLOSE | SWT.RESIZE);
		result_SHELL.setText("Result: ");
		result_SHELL.setMinimumSize(500, 100);
		result_SHELL.setLayout(new FillLayout());
		result_SHELL.setImage(Main.resultIcon);
